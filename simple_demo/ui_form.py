...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.button.setGeometry(QRect(100, 470, 151, 41))
        self.check = QCheckBox(self.centralwidget)
        self.check.setObjectName(u"check")
        self.check.setGeometry(QRect(280, 480, 92, 24))
        self.motor = QLabel(self.centralwidget)
        self.motor.setObjectName(u"motor")
        self.motor.setGeometry(QRect(110, 70, 571, 271))
        self.motor.setPixmap(QPixmap(u"img/button0.png"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.button.setText(QCoreApplication.translate("MainWindow", u"Power", None))
